    ...
    <div style={{ padding: "32px", width: "900px" }}>
      <Row>
        <Card ribbon={<CardRibbon text="Ribbon" />}>
          ...
          <CardBody style={{ height: "450px" }}>Body</CardBody>
        </Card>
      </Row>
      <Row>
        <Card ribbon={<CardRibbon variantColor="textDisabled" text="Ribbon with Long Text" />}>
          <CardBody style={{ height: "450px" }}>Ribbons will truncate when text is too long</CardBody>
        </Card>
      </Row>
      <Row>
        <Card ribbon={<CardRibbon variantColor="success" text="Success" />}>
          <CardBody style={{ height: "450px" }}>Card</CardBody>
        </Card>
      </Row>
      <Row>
        <Card ribbon={<CardRibbon variantColor="failure" text="Failure" />}>
          <CardBody style={{ height: "450px" }}>Any Color in the theme</CardBody>
        </Card>
      </Row>
    </div>
  );
